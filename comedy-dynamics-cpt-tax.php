<?php
/*
Plugin Name: Comedy Dynamics CPT & Tax
Plugin URI: https://github.com/Nacelle-Company/nacellecompany
Description: Creates custom post types & taxonomies for Comedy Dynamics.
Version: 1.0
Author: Luke Carl Hartman
Author URI: https://github.com/luukee
License: GPLv2
Link: https://github.com/Nacelle-Company/nacellecompany
*/

defined( 'ABSPATH' ) or die( 'Hey what you doing?' );

class ComedyDynamicsCPTandTax {

	function __construct() {
		add_action( 'init', array( $this, 'cd_custom_post_type' ) );
		add_action( 'init', array( $this, 'cd_register_taxes' ) );
	}

	function activate() {
		$this->cd_custom_post_type();
		$this->cd_register_taxes();
		flush_rewrite_rules();
	}
	...
	function cd_custom_post_type() {
		...
		$labels = array(
			'name'                     => __( 'Comedies', 'wp-rig' ),
			'singular_name'            => __( 'Comedy', 'wp-rig' ),
			'menu_name'                => __( 'Comedies', 'wp-rig' ),
			'all_items'                => __( 'All Comedies', 'wp-rig' ),
			'add_new'                  => __( 'Add new', 'wp-rig' ),
			'add_new_item'             => __( 'Add new Comedy', 'wp-rig' ),
			'edit_item'                => __( 'Edit Comedy', 'wp-rig' ),
			'new_item'                 => __( 'New Comedy', 'wp-rig' ),
			'view_item'                => __( 'View Comedy', 'wp-rig' ),
			'view_items'               => __( 'View Comedies', 'wp-rig' ),
			'search_items'             => __( 'Search Comedies', 'wp-rig' ),
			'not_found'                => __( 'No Comedies found', 'wp-rig' ),
			'not_found_in_trash'       => __( 'No Comedies found in trash', 'wp-rig' ),
			'parent'                   => __( 'Parent Comedy:', 'wp-rig' ),
			'featured_image'           => __( 'Featured image for this Comedy', 'wp-rig' ),
			'set_featured_image'       => __( 'Set featured image for this Comedy', 'wp-rig' ),
			'remove_featured_image'    => __( 'Remove featured image for this Comedy', 'wp-rig' ),
			'use_featured_image'       => __( 'Use as featured image for this Comedy', 'wp-rig' ),
			'archives'                 => __( 'Comedy archives', 'wp-rig' ),
			'insert_into_item'         => __( 'Insert into Comedy', 'wp-rig' ),
			'uploaded_to_this_item'    => __( 'Upload to this Comedy', 'wp-rig' ),
			'filter_items_list'        => __( 'Filter Comedies list', 'wp-rig' ),
			'items_list_navigation'    => __( 'Comedies list navigation', 'wp-rig' ),
			'items_list'               => __( 'Comedies list', 'wp-rig' ),
			'attributes'               => __( 'Comedies attributes', 'wp-rig' ),
			'name_admin_bar'           => __( 'Comedy', 'wp-rig' ),
			'item_published'           => __( 'Comedy published', 'wp-rig' ),
			'item_published_privately' => __( 'Comedy published privately.', 'wp-rig' ),
			'item_reverted_to_draft'   => __( 'Comedy reverted to draft.', 'wp-rig' ),
			'item_scheduled'           => __( 'Comedy scheduled', 'wp-rig' ),
			'item_updated'             => __( 'Comedy updated.', 'wp-rig' ),
			'parent_item_colon'        => __( 'Parent Comedy:', 'wp-rig' ),
		);

		$args = array(
			'label'                 => __( 'Comedies', 'wp-rig' ),
			'labels'                => $labels,
...
if ( class_exists( 'ComedyDynamicsCPTandTax' ) ) {

	$comedy_dynamics_cpt_tax = new ComedyDynamicsCPTandTax();

}


// activation
register_activation_hook( __FILE__, array( $comedy_dynamics_cpt_tax, 'activate' ) );

// deactivation
register_deactivation_hook( __FILE__, array( $comedy_dynamics_cpt_tax, 'deactivate' ) );
